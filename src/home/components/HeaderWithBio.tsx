  ...
  return (
    <div className="flex flex-col font-sans text-white gap-6 px-12 pt-12">
      ...
      Hello ! Je suis Théo Sementa, développeur logiciel spécialisé dans le développement mobile avec une expertise en iOS (Swift/SwiftUI)
       et un intérêt croissant pour Kotlin Multiplatform et Jetpack Compose. Je travaille également sur des projets web avec React et NestJS.
       Actuellement, je poursuis un master à Metz Numeric School pour perfectionner mes compétences et élargir mon expertise.
      </p>
    </div>
  )
}